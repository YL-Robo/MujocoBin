...
class Test(mujoco_viewer.CustomViewer):
    ...
    def runBefore(self):
        self.end_effector_id = mujoco.mj_name2id(self.model, mujoco.mjtObj.mjOBJ_BODY, 'link5')
...
test = Test("/home/zxy/MujocoBin/mujoco-learning/model/trs_so_arm100/scene_with_table.xml")
test.run_loop()